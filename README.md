...
3. A produção do programa gostaria de ter URLs (a serem especificadas) para consultar:
3.1  Total geral de votos;
3.2  Total por participante;
3.3  Total de votos por hora em cada paredão;
3.4  As interfaces não podem ser apenas números e/ou textos 
Imagine suas rotas de consulta sendo utilizadas como dashboards de monitoração por uma equipe que acompanha o programa.
...
5. Implementar um CRUD para adicionar/consultar/atualizar/remover participantes para votações.
